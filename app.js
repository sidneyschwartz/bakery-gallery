...
const updatePage = async () => {
  ...
  const fruitsAndCalories = fruitsArray.map((fruit) => ({
    name: fruit.name,
    calories: fruit.nutritions.calories,
  }));
  console.log(fruitsAndCalories);
  ...
  fruitsAndCalories.forEach((fruit) => {
    const fruitElement = document.createElement("div");
    fruitElement.classList += "fruit";
    fruitElement.innerHTML = fruit.name + " (" + fruit.calories + " calories)";
    fruitsList.append(fruitElement);
  });
};
